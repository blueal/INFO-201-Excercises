...
sentence <- tolower("This is a long sentence that I will make lowercase.")
...
count_occurrences <- function(letter, v_letters){
  return(length(v_letters[v_letters == letter]))
}

# Call your `count_occurrences()` function to see how many times the letter 'e'
# is in your sentence.

print(count_occurrences("e", letters))
...
frquencies <- as.list(sapply(unique_letters, count_occurrences, letters))
